...
class ManagedContentClient:
    ...
    def __init__(self, url, version, token):
        self.serviceconnector = ServiceConnector(url, version, token)
    ...
    def _upload(self, key: str, stream_name: str, stream: object, content_type: str):
        ...
        r = self.serviceconnector.request('POST', uri, data, headers)
    ...
    def _upload_streaming(self, key: str, stream: object, content_type: str):
        ...
        r = self.serviceconnector.request('POST', uri, stream, headers)
        raise_for_status_with_detail(r)
        return r.json()
    ...
    def _download(self, key: str):
        uri = self._make_content_uri(key)
        r = self.serviceconnector.request('GET', uri, stream=True)
        raise_for_status_with_detail(r)
        return r.raw
    ...
    def exists(self, key: str) -> bool:
        ...
        """
        uri = self._make_content_uri(key)
        r = self.serviceconnector.request('HEAD', uri)
